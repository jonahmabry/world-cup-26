...
Every match in the bracket SHALL carry and display its host city, date, and kickoff time, sourced from the official FIFA 2026 schedule and keyed by match number.
